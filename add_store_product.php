              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="GET">
                    ...
                    <div class="form-group">
                      <label for="exampleInputCategory">Product Quentity : </label>
                      <input type="text" name="store_product_quentity"  class="form-control" id="exampleInputCategory" aria-describedby="emailHelp"
                    ...
                    <label for="simpleDataInput">Product Entry Date</label>
                        <div class="input-group date">
                            ...
                            <input type="text" name="store_product_entry_date" class="form-control" value="<?php echo $date ?>" id="simpleDataInput">
                        </div>
                    </div>
